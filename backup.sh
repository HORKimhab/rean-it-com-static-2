...
TIMESTAMP_UTC7="$(TZ=Asia/Phnom_Penh date '+%Y-%m-%d %H:%M:%S UTC+007')"
CAPTION="project: rean-it-static-2 and url: https://github.com/HORKimhab/rean-it-com-static-2 | Time: ${TIMESTAMP_UTC7}"
